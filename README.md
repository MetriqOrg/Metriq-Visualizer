...
```bash
sudo apt update
sudo apt install ffmpeg python3-pip python3-venv libgl1 libegl1 libxkbcommon-x11-0 libxcb-cursor0 libpulse0

# Open a terminal inside the extracted GitHub source folder, commonly:
